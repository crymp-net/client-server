...
class VehicleDamageBehaviorDetachPart : public IVehicleDamageBehavior
{
#ifdef BUILD_64BIT
...
public:
	VehicleDamageBehaviorDetachPart();
...
#ifdef BUILD_64BIT
static_assert(sizeof(VehicleDamageBehaviorDetachPart) == 0x30);
#else
static_assert(sizeof(VehicleDamageBehaviorDetachPart) == 0x18);
#endif
