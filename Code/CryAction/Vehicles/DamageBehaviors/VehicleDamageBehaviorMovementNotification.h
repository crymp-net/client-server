...
class VehicleDamageBehaviorMovementNotification : public IVehicleDamageBehavior
{
#ifdef BUILD_64BIT
...
public:
	VehicleDamageBehaviorMovementNotification();
...
#ifdef BUILD_64BIT
static_assert(sizeof(VehicleDamageBehaviorMovementNotification) == 0x18);
#else
static_assert(sizeof(VehicleDamageBehaviorMovementNotification) == 0x10);
#endif
