...
bool US_ltv::Init(IGameObject* pGameObject)
{
	...
	// Scripts/Entities/Vehicles/Implementations/Xml/US_ltv.xml
	...
	// Parts
	{
		SmartScriptTable parts(gEnv->pScriptSystem);
		{
			...
			}
			{
				...
				SmartScriptTable shitenTurret_part_parts(gEnv->pScriptSystem);
				{
					...
					SmartScriptTable shiten_part_helpers(gEnv->pScriptSystem);
					{
						...
						gunnerEyePos_helper->SetValue("position", Vec3(0.0029, -0.054200001, 2.6229999));
					...
					}
					{
						...
						driverEyePos_helper->SetValue("position", Vec3(-0.62599999, 0.69090003, 1.8658));
			...
			SmartScriptTable body_part_helpers(gEnv->pScriptSystem);
			{
				...
				passenger_eye_pos_helper->SetValue("position", Vec3(0.68989998, 0.676, 1.87));
			...
			}
			{
				...
				passenger_sit_pos_helper->SetValue("position", Vec3(0.78390002, 0.60600001, 0.93699998));
			...
			}
			{
				...
				driver_exit_pos_helper->SetValue("position", Vec3(-2.1472001, 0.4709, 0.815));
			...
			}
			{
				...
				engineSmokeOut_helper->SetValue("position", Vec3(0.0339, 2.6040001, 1.087));
			...
			}
			{
				...
				headLightLeft_helper->SetValue("position", Vec3(-0.5625, 3.2512, 1.1289999));
			...
			}
			{
				...
				headLightCenter_helper->SetValue("position", Vec3(-0.017100001, 3.3278999, 1.148));
			...
			}
			{
				...
				brakeLightLeft_helper->SetValue("position", Vec3(-1.0369, -2.3146999, 1.1487));
			...
			}
			{
				...
				brakeLightRight_helper->SetValue("position", Vec3(1.0319999, -2.3069, 1.1496));
			...
			}
			{
				...
				rearLightLeft_helper->SetValue("position", Vec3(-0.9307, -2.3146999, 1.1487));
			...
			}
			{
				...
				burningPos_helper->SetValue("position", Vec3(0, 0.46509999, 0.7572));
			...
			}
			{
				...
				exhaust_pos_left_helper->SetValue("position", Vec3(-0.79079998, -2.4001, 0.83099997));
			...
			}
			{
				...
				exhaust_pos_right_helper->SetValue("position", Vec3(0.79079998, -2.4001, 0.83099997));
			...
			}
			{
				...
				left_rear_exit_pos_helper->SetValue("position", Vec3(1.9680001, -0.72970003, 0.745));
			...
			}
			{
				...
				right_rear_eye_pos_helper->SetValue("position", Vec3(0.72579998, -0.33500001, 1.824));
			...
			}
			{
				...
				left_rear_eye_pos_helper->SetValue("position", Vec3(-0.62989998, -0.31979999, 1.8));
			...
			}
			{
				...
				fuelCanPos_helper->SetValue("position", Vec3(-0.4932, -2.3717999, 1.251));
			...
			}
			{
				...
				dashboardPos_helper->SetValue("position", Vec3(-0.71899998, 1.321, 1.506));
			...
			}
			{
				...
				centerPos_helper->SetValue("position", Vec3(0, 0.33739999, 0.97750002));
		...
		}
		{
			...
			massBox_part->SetValue("position", Vec3(0.0012000001, 0.28389999, 1.005));
	...
	}
	{
		...
		component->SetValue("maxBound", Vec3(1.1921, 3.5021999, 1.681));
		component->SetValue("useBoundsFromParts", false);
	...
	}
	{
		...
		component->SetValue("damageMax", 45.0f);
		component->SetValue("major", true);
		component->SetValue("minBound", Vec3(-0.64920002, -2.5641999, 1.0029));
		component->SetValue("maxBound", Vec3(-0.31420001, -2.2756, 1.4878));
		component->SetValue("useBoundsFromParts", false);
		component->SetValue("hullAffection", 1.0f);
		component->SetValue("isOnlyDamageableByPlayer", true);
		SmartScriptTable component_damagemultipliers(gEnv->pScriptSystem);
	...
	{
		SmartScriptTable component(gEnv->pScriptSystem);
		component->SetValue("name", "Roof");
		component->SetValue("damageMax", 0.0f);
		component->SetValue("major", false);
		component->SetValue("minBound", Vec3(-1.198, -2.7959001, 1.5585001));
		component->SetValue("maxBound", Vec3(1.198, 1.5122, 2.5386));
		component->SetValue("useBoundsFromParts", false);
		SmartScriptTable component_damagebehaviors(gEnv->pScriptSystem);
		component->SetValue("DamageBehaviors", component_damagebehaviors);

		VehicleComponent* roof = new VehicleComponent();
		roof->Init(this, component);
		m_components.push_back(roof);
	}
	{
		SmartScriptTable component(gEnv->pScriptSystem);
	...
	// Particles
	{
		...
		}
		{
			...
			HullDamaged25_damageeffect->SetValue("scaleMax", 0.60000002f);
		...
		}
		{
			...
			HullDamaged75_damageeffect->SetValue("scaleMax", 0.80000001f);
	...
	// MovementParams
	{
		...
		movement_wheeled->SetValue("latFriction", 1.0f);
