...
bool US_tank::Init(IGameObject* pGameObject)
{
	...
	// Scripts/Entities/Vehicles/Implementations/Xml/US_tank.xml
	...
	// Parts
	{
		SmartScriptTable parts(gEnv->pScriptSystem);
		{
			...
			SmartScriptTable tank_part_parts(gEnv->pScriptSystem);
			{
				...
				SmartScriptTable turret_part_parts(gEnv->pScriptSystem);
				{
					...
					SmartScriptTable cannon_base_part_parts(gEnv->pScriptSystem);
					{
						...
						else if (StringTools::IsEqualNoCase(m_modName, "FullGauss"))
						{
							cannon_part->SetValue("useOption", 1);
						}
						else
						...
						SmartScriptTable cannon_part_helpers(gEnv->pScriptSystem);
						{
							...
							cannonOut_helper->SetValue("position", Vec3(0, 6.5261002, 2.1170001));
						...
						}
						{
							...
							cannonBase_helper->SetValue("position", Vec3(0, 1, 2.117));
						...
						}
						{
							...
							cannonViewPos_helper->SetValue("position", Vec3(-0.56099999, 1.0759, 2.5191));
						...
						}
						{
							...
							ghostViewPos_helper->SetValue("position", Vec3(0.0264, 5.2238998, 3.0525999));
						...
						}
						{
							...
							coaxOut_helper->SetValue("position", Vec3(0.2852, 1.5771, 2.1199999));
						...
						}
						{
							...
							cannonOutMOAC_helper->SetValue("position", Vec3(-0.034400001, 4.1862998, 2.0274999));
					...
					SmartScriptTable cannon_base_part_helpers(gEnv->pScriptSystem);
					cannon_base_part->SetValue("Helpers", cannon_base_part_helpers);
					...
					cannon_base_part_animatedjoint_rotation->SetValue("pitchSpeed", 32.0f);
					cannon_base_part_animatedjoint_rotation->SetValue("pitchAccel", 100.0f);
				...
				}
				{
					...
					SmartScriptTable shitenTurret_part_parts(gEnv->pScriptSystem);
					{
						...
						SmartScriptTable shiten_part_helpers(gEnv->pScriptSystem);
						{
							...
							gunnerEyePos_helper->SetValue("position", Vec3(0.67500001, -1.2459, 3.4590001));
						...
						}
						{
							...
							searchLightPos_helper->SetValue("position", Vec3(0.84, -0.67, 3.16));
						...
						shiten_part_animatedjoint->SetValue("filename", "");
						shiten_part_animatedjoint->SetValue("filenameDestroyed", "");
				...
				SmartScriptTable turret_part_helpers(gEnv->pScriptSystem);
				{
					...
					driverSitPos_helper->SetValue("position", Vec3(0.66240001, -1.4275, 2.0504));
				...
				}
				{
					...
					turretPos_helper->SetValue("position", Vec3(-0.001, -0.82889998, 2.1110001));
				...
				turret_part_animatedjoint_rotation->SetValue("yawSpeed", 39.0f);
				turret_part_animatedjoint_rotation->SetValue("yawAccel", 120.0f);
			...
			}
			{
				...
				wheel2_part_subpartwheel->SetValue("lenMax", 0.75f);
				...
				wheel2_part_subpartwheel->SetValue("suspLength", 0.47f);
			...
			}
			{
				...
				wheel3_part_subpartwheel->SetValue("lenMax", 0.75f);
				...
				wheel3_part_subpartwheel->SetValue("suspLength", 0.47f);
			...
			}
			{
				...
				wheel4_part_subpartwheel->SetValue("lenMax", 0.75f);
				...
				wheel4_part_subpartwheel->SetValue("suspLength", 0.47f);
			...
			}
			{
				...
				wheel5_part_subpartwheel->SetValue("lenMax", 0.75f);
				...
				wheel5_part_subpartwheel->SetValue("suspLength", 0.47f);
			...
			}
			{
				...
				wheel6_part_subpartwheel->SetValue("lenMax", 0.75f);
				...
				wheel6_part_subpartwheel->SetValue("suspLength", 0.47f);
			...
			}
			{
				...
				wheel7_part_subpartwheel->SetValue("lenMax", 0.75f);
				...
				wheel7_part_subpartwheel->SetValue("suspLength", 0.47f);
			...
			}
			{
				...
				wheel10_part_subpartwheel->SetValue("lenMax", 0.75f);
				...
				wheel10_part_subpartwheel->SetValue("suspLength", 0.47f);
			...
			}
			{
				...
				wheel11_part_subpartwheel->SetValue("lenMax", 0.75f);
				...
				wheel11_part_subpartwheel->SetValue("suspLength", 0.47f);
			...
			}
			{
				...
				wheel12_part_subpartwheel->SetValue("lenMax", 0.75f);
				...
				wheel12_part_subpartwheel->SetValue("suspLength", 0.47f);
			...
			}
			{
				...
				wheel13_part_subpartwheel->SetValue("lenMax", 0.75f);
				...
				wheel13_part_subpartwheel->SetValue("suspLength", 0.47f);
			...
			}
			{
				...
				wheel14_part_subpartwheel->SetValue("lenMax", 0.75f);
				...
				wheel14_part_subpartwheel->SetValue("suspLength", 0.47f);
			...
			}
			{
				...
				wheel15_part_subpartwheel->SetValue("lenMax", 0.75f);
				...
				wheel15_part_subpartwheel->SetValue("suspLength", 0.47f);
			...
			SmartScriptTable tank_part_helpers(gEnv->pScriptSystem);
			{
				...
				else if (StringTools::IsEqualNoCase(m_modName, "GaussRifle"))
				{
					driverEnterPos_helper->SetValue("position", Vec3(-3.3520999, -0.38240001, 0.50300002));
				}
				else if (StringTools::IsEqualNoCase(m_modName, "FullGauss"))
				...
				{
					driverEnterPos_helper->SetValue("position", Vec3(3.3215001, -0.57080001, 0.50300002));
				}
			...
			}
			{
				...
				gunnerEnterPos_helper->SetValue("position", Vec3(3.3108001, -1.4680001, 0.49900001));
			...
			}
			{
				...
				engineSmokeOut_helper->SetValue("position", Vec3(-0.001, -4.0922999, 1.801));
			...
			}
			{
				...
				burningPos_helper->SetValue("position", Vec3(0, -0.86110002, 1.234));
				burningPos_helper->SetValue("direction", Vec3(0.0020999999, 0, 1));
			...
			}
			{
				...
				ai_anchor2_helper->SetValue("position", Vec3(-2.925, -3.5818, 0.77499998));
				ai_anchor2_helper->SetValue("direction", Vec3(0.9659, -0.259, -0.0020999999));
			...
			}
			{
				...
				ai_anchor3_helper->SetValue("position", Vec3(3.302, -3.4302001, 0.79299998));
				ai_anchor3_helper->SetValue("direction", Vec3(-0.93970001, -0.34189999, 0.0020000001));
			...
			}
			{
				...
				ai_anchor4_helper->SetValue("position", Vec3(-3.2047999, 2.0042, 0.61000001));
				ai_anchor4_helper->SetValue("direction", Vec3(0.70709997, 0.70709997, -0.0014));
			...
			}
			{
				...
				ai_anchor5_helper->SetValue("position", Vec3(3.3153999, 1.6711, 0.68300003));
				ai_anchor5_helper->SetValue("direction", Vec3(-0.81889999, 0.57389998, 0.0018));
			...
			}
			{
				...
				exhaust_helper->SetValue("position", Vec3(-0.76419997, -5.5430002, 1.303));
				exhaust_helper->SetValue("direction", Vec3(-0.0019, -0.92030001, -0.39120001));
			...
			}
			{
				...
				headLightLeft_helper->SetValue("position", Vec3(1.7117, 3.1903999, 1.4432));
			...
			}
			{
				...
				headLightRight_helper->SetValue("position", Vec3(-1.6982, 3.1847999, 1.444));
			...
			}
			{
				...
				headLightCenter_helper->SetValue("position", Vec3(0.0176, 3.2937, 1.476));
			...
			}
			{
				...
				rearLightLeft_helper->SetValue("position", Vec3(-1.9845999, -5.3874998, 1.5842));
			...
			}
			{
				...
				rearLightRight_helper->SetValue("position", Vec3(1.9873, -5.3892002, 1.6021));
			...
			}
			{
				...
				centerPos_helper->SetValue("position", Vec3(-0.0082999999, -1.7976, 1.1338));
			...
			tank_part_animated->SetValue("filename", "Objects/Vehicles/us_tank/us_tank.cga");
			tank_part_animated->SetValue("filenameDestroyed", "Objects/Vehicles/us_tank/us_tank_damaged.cga");
		...
		}
		{
			...
			leftTread_part_tread->SetValue("filename", "Objects/Vehicles/us_tank/tread_left.chr");
			leftTread_part_tread->SetValue("materialName", "us_tank_treads");
		...
		}
		{
			...
			rightTread_part_tread->SetValue("filename", "Objects/Vehicles/us_tank/tread_right.chr");
			rightTread_part_tread->SetValue("materialName", "us_tank_treads");
		...
		}
		{
			...
			massBox_part->SetValue("position", Vec3(0.00050000002, -0.87180001, 0.93169999));
		...
		{
			SmartScriptTable lumberjack_part(gEnv->pScriptSystem);
			lumberjack_part->SetValue("name", "lumberjack");
			lumberjack_part->SetValue("class", "MassBox");
			lumberjack_part->SetValue("component", "");
			lumberjack_part->SetValue("mass", 0.0f);
			lumberjack_part->SetValue("position", Vec3(0.00050000002, -0.50199997, 1.3233));
			lumberjack_part->SetValue("disablePhysics", false);
			lumberjack_part->SetValue("disableCollision", false);
			lumberjack_part->SetValue("isHidden", false);
			SmartScriptTable lumberjack_part_helpers(gEnv->pScriptSystem);
			lumberjack_part->SetValue("Helpers", lumberjack_part_helpers);
			SmartScriptTable lumberjack_part_massbox(gEnv->pScriptSystem);
			lumberjack_part_massbox->SetValue("size", Vec3(2.4716001, 5.1023002, 0.98000002));
			lumberjack_part_massbox->SetValue("lumberjack", true);
			lumberjack_part->SetValue("MassBox", lumberjack_part_massbox);
			parts->PushBack(lumberjack_part);
		}
		{
	...
	// Components
	{
		...
		if (StringTools::IsEqualNoCase(m_modName, "MP"))
		{
			component->SetValue("damageMax", 1500.0f);
		}
		else if (StringTools::IsEqualNoCase(m_modName, "GaussCannon"))
		{
			component->SetValue("damageMax", 1500.0f);
		...
		component->SetValue("minBound", Vec3(-2.47, -5.8, 0.65));
		component->SetValue("maxBound", Vec3(2.74, 3.6, 1.95));
	...
	}
	{
		...
		component->SetValue("major", true);
		component->SetValue("minBound", Vec3(-1.25, -5.7209001, 0.47420001));
		component->SetValue("maxBound", Vec3(1.25, -3.1008, 2.0799));
		component->SetValue("useBoundsFromParts", false);
		component->SetValue("hullAffection", 1.5f);
		SmartScriptTable component_damagemultipliers(gEnv->pScriptSystem);
		{
			SmartScriptTable damagemultiplier(gEnv->pScriptSystem);
			damagemultiplier->SetValue("damageType", "fire");
	...
	}
	{
		...
		component->SetValue("damageMax", 1100.0f);
		component->SetValue("major", true);
		component->SetValue("minBound", Vec3(-3.7, -5, 1.95));
		component->SetValue("maxBound", Vec3(3.7, 2.2, 3));
		component->SetValue("useBoundsFromParts", false);
	...
	}
	{
		...
		component->SetValue("major", true);
		component->SetValue("minBound", Vec3(-2.15, -5.2, -0.2166));
		component->SetValue("maxBound", Vec3(-1.2, 3.4, 1.3332));
		component->SetValue("useBoundsFromParts", false);
		component->SetValue("hullAffection", 0.75f);
		SmartScriptTable component_damagemultipliers(gEnv->pScriptSystem);
		{
	...
	}
	{
		...
		component->SetValue("damageMax", 490.0f);
		component->SetValue("major", true);
		component->SetValue("minBound", Vec3(1.2, -5.2, -0.2191));
		component->SetValue("maxBound", Vec3(2.15, 3.4, 1.3308001));
		component->SetValue("useBoundsFromParts", false);
		component->SetValue("hullAffection", 0.75f);
		SmartScriptTable component_damagemultipliers(gEnv->pScriptSystem);
		{
	...
	}
	{
		...
		component->SetValue("minBound", Vec3(-2.7175, -4.1718998, 0.061099999));
		component->SetValue("maxBound", Vec3(-1.342, 2.2578001, 1.7693));
		component->SetValue("useBoundsFromParts", false);
		SmartScriptTable component_damagebehaviors(gEnv->pScriptSystem);
		component->SetValue("DamageBehaviors", component_damagebehaviors);
	...
	}
	{
		...
		component->SetValue("damageMax", 0.0f);
		component->SetValue("major", false);
		component->SetValue("minBound", Vec3(1.3123, -4.3059001, 0.0253));
		component->SetValue("maxBound", Vec3(2.6784999, 2.4040999, 1.8661));
		component->SetValue("useBoundsFromParts", false);
		SmartScriptTable component_damagebehaviors(gEnv->pScriptSystem);
		component->SetValue("DamageBehaviors", component_damagebehaviors);
	...
	}
	{
		...
		component->SetValue("damageMax", 0.0f);
		component->SetValue("major", false);
		component->SetValue("minBound", Vec3(-0.94779998, -2.8341999, 2.2212));
		component->SetValue("maxBound", Vec3(1.2559, -0.20919999, 3.7695999));
		component->SetValue("useBoundsFromParts", false);
		SmartScriptTable component_damagebehaviors(gEnv->pScriptSystem);
		component->SetValue("DamageBehaviors", component_damagebehaviors);
	...
	}
	{
		...
		}
		{
			...
			damagebehavior_burn->SetValue("selfDamage", 150.0f);
			damagebehavior_burn->SetValue("radius", 7.0f);
	...
	// Particles
	{
		...
		SmartScriptTable particles_damageeffects(gEnv->pScriptSystem);
		{
			...
			EngineDamaged25_damageeffect->SetValue("effect", "Vehicle_fx.Damages_Land.USTank_engine_smoke_a");
		...
		}
		{
			...
			EngineDamaged75_damageeffect->SetValue("effect", "Vehicle_fx.Damages_Land.USTank_engine_smoke_b");
		...
		}
		{
			...
			HullDamaged25_damageeffect->SetValue("effect", "Vehicle_fx.Damages_Land.USTank_hull_smoke_a");
		...
		}
		{
			...
			HullDamaged75_damageeffect->SetValue("effect", "Vehicle_fx.Damages_Land.USTank_hull_smoke_b");
	...
	// MovementParams
	{
		...
		movement_wheeled->SetValue("axleFriction", 600);
		...
		movement_wheeled->SetValue("engineMaxRPM", 2650);
		...
		movement_wheeled->SetValue("maxSpeed", 16.0f);
		...
		movement_wheeled->SetValue("pullTilt", 7.0f);
		movement_wheeled->SetValue("latFriction", 0.5f);
		if (StringTools::IsEqualNoCase(m_modName, "TACCannon"))
		{
			movement_wheeled->SetValue("maxGear", 2);
		}
		else if (StringTools::IsEqualNoCase(m_modName, "Singularity"))
		{
			movement_wheeled->SetValue("maxGear", 2);
		...
		{
			movement_wheeled->SetValue("maxGear", 0);
		}
		...
		movement_soundparams->SetValue("runSoundDelay", 1.5f);
	...
	// Seats
	{
		...
		}
		{
			...
			view_actionthirdperson->SetValue("cameraPosOffset", Vec3(0, -6.6, 1));
		...
		}
		{
			...
			SmartScriptTable seataction_weapons_weapons(gEnv->pScriptSystem);
			{
				...
				{
					weapon->SetValue("class", "USTankCannon");
				}
		...
		}
		{
			...
			{
				SmartScriptTable weapon(gEnv->pScriptSystem);
				weapon->SetValue("class", "USCoaxialGun");
				weapon->SetValue("part", "cannon_base");
				SmartScriptTable weapon_helpers(gEnv->pScriptSystem);
	...
	this->SetAmmoCapacity("gausstankbullet", 10);
	this->SetAmmoCapacity("tacprojectile", 2);
	this->SetAmmoCapacity("Tank_singularityprojectile", 10);

	// Paints
	if (StringTools::IsEqualNoCase(m_paintName, "nk"))
	{
		this->SetPaintMaterial("objects/vehicles/us_tank/us_tank_nk.mtl");
	}
	else if (StringTools::IsEqualNoCase(m_paintName, "us"))
	{
		this->SetPaintMaterial("objects/vehicles/us_tank/us_tank.mtl");
	}
		...
		SmartScriptTable damages_damagesgroups(gEnv->pScriptSystem);
		{
			...
			SmartScriptTable Destroy_damagesgroup_damagessubgroups(gEnv->pScriptSystem);
			{
				...
				SmartScriptTable damagessubgroup_damagebehaviors(gEnv->pScriptSystem);
				{
					...
					damagebehavior_impulse->SetValue("forceMin", 1.0f);
					damagebehavior_impulse->SetValue("forceMax", 1.5f);
					damagebehavior_impulse->SetValue("direction", Vec3(0, 0, 1));
					damagebehavior_impulse->SetValue("momentum", Vec3(-0.2, 0.2, 0));
