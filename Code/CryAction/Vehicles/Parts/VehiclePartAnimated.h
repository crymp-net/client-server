...
class VehiclePartAnimated : public IVehiclePart
{
#ifdef BUILD_64BIT
	unsigned char m_data[0x268 - 0x8] = {};
#else
	unsigned char m_data[0x1c8 - 0x4] = {};
#endif
...
#ifdef BUILD_64BIT
static_assert(sizeof(VehiclePartAnimated) == 0x268);
#else
static_assert(sizeof(VehiclePartAnimated) == 0x1c8);
#endif
