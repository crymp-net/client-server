...
class VehiclePartAnimatedJoint : public IVehiclePart
{
#ifdef BUILD_64BIT
	unsigned char m_data[0x2d0 - 0x8] = {};
#else
	unsigned char m_data[0x264 - 0x4] = {};
#endif

public:
	VehiclePartAnimatedJoint();
...
#ifdef BUILD_64BIT
static_assert(sizeof(VehiclePartAnimatedJoint) == 0x2d0);
#else
static_assert(sizeof(VehiclePartAnimatedJoint) == 0x264);
#endif
