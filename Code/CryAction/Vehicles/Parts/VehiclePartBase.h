...
class VehiclePartBase : public IVehiclePart
{
protected:
	EVehiclePartType m_type = eVPT_Base;

#ifdef BUILD_64BIT
	unsigned char m_data[0x1b8 - 0x8 - 0x8] = {};
#else
	unsigned char m_data[0x168 - 0x4 - 0x4] = {};
#endif
...
#ifdef BUILD_64BIT
static_assert(sizeof(VehiclePartBase) == 0x1b8);
#else
static_assert(sizeof(VehiclePartBase) == 0x168);
#endif
