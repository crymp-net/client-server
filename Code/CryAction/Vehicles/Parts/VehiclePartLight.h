...
class VehiclePartLight : public IVehiclePart
{
#ifdef BUILD_64BIT
	unsigned char m_data[0x460 - 0x8] = {};
#else
	unsigned char m_data[0x39c - 0x4] = {};
#endif
...
#ifdef BUILD_64BIT
static_assert(sizeof(VehiclePartLight) == 0x460);
#else
static_assert(sizeof(VehiclePartLight) == 0x39c);
#endif
