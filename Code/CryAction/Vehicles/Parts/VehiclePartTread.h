...
class VehiclePartTread : public IVehiclePart
{
#ifdef BUILD_64BIT
	unsigned char m_data[0x1f8 - 0x8] = {};
#else
	unsigned char m_data[0x190 - 0x4] = {};
#endif
...
#ifdef BUILD_64BIT
static_assert(sizeof(VehiclePartTread) == 0x1f8);
#else
static_assert(sizeof(VehiclePartTread) == 0x190);
#endif
