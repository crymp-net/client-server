...
class VehicleSeatActionWeapons : public IVehicleSeatAction
{
#ifdef BUILD_64BIT
	unsigned char m_data[0x68 - 0x8] = {};
#else
	unsigned char m_data[0x44 - 0x4] = {};
#endif

public:
	VehicleSeatActionWeapons();
...
#ifdef BUILD_64BIT
static_assert(sizeof(VehicleSeatActionWeapons) == 0x68);
#else
static_assert(sizeof(VehicleSeatActionWeapons) == 0x44);
#endif
