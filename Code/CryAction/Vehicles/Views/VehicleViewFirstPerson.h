...
class VehicleViewFirstPerson : public IVehicleView
{
#ifdef BUILD_64BIT
	unsigned char m_data[0x138 - 0x8] = {};
#else
	unsigned char m_data[0x100 - 0x4] = {};
#endif

public:
	VehicleViewFirstPerson();
...
#ifdef BUILD_64BIT
static_assert(sizeof(VehicleViewFirstPerson) == 0x138);
#else
static_assert(sizeof(VehicleViewFirstPerson) == 0x100);
#endif
