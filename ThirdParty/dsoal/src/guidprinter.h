...
#define CHECKID(x) else if(guid == x) mIdStr = #x;
    ...
    {
        if(false) { }
        CHECKID(_DSPROPSETID_EAX10_ListenerProperties)
        CHECKID(_DSPROPSETID_EAX10_BufferProperties)
        CHECKID(_DSPROPSETID_EAX20_ListenerProperties)
        CHECKID(_DSPROPSETID_EAX20_BufferProperties)
        CHECKID(_DSPROPSETID_EAX30_ListenerProperties)
        CHECKID(_DSPROPSETID_EAX30_BufferProperties)
        CHECKID(_EAXPROPERTYID_EAX40_Context)
        CHECKID(_EAXPROPERTYID_EAX40_FXSlot0)
        CHECKID(_EAXPROPERTYID_EAX40_FXSlot1)
        CHECKID(_EAXPROPERTYID_EAX40_FXSlot2)
        CHECKID(_EAXPROPERTYID_EAX40_FXSlot3)
        CHECKID(_EAXPROPERTYID_EAX40_Source)
